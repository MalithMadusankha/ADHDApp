...
import CarretImg from '../../../assets/img/game/carrot.png';
import ButterflyImg from '../../../assets/img/game/butterfly.png';
import TreeImg from '../../../assets/img/game/tree.png';

const MatchLevel1Screen = ({navigation}) => {
  ...
  const images = [CarretImg, ButterflyImg, TreeImg];
        ...
        <View
          ...
          <View style={[TM.flexDirRow, TM.justifySpaceAround]}>
            <TouchableOpacity style={[TM.p2, TM.m1, TM.borderRadius10]}>
              <Image style={[styles.objGame]} source={TreeImg} />
            </TouchableOpacity>
            <TouchableOpacity
          ...
          <View style={[TM.justAlign, TM.flexDirRow]}>
            ...
            <TouchableOpacity
              ...
              <Text style={[TM.f30]}> {parseInt(countR / 3)}</Text>
            </TouchableOpacity>
          </View>
        </View>
      </ImageBackground>
...
export default MatchLevel1Screen;
