...
const FindObjLevel1Screen = ({navigation}) => {
  ...
  const next = () => {
    ...
    const game = {
      duration,
      marks: chosseObj1 + chosseObj2 + chosseObj3 + isNoCorrect,
      totalMark: 5,
      gameType: 0,
      lavel: 1,
    };
        ...
        <View
          ...
          <View style={[TM.flexDirRow]}>
            <Text style={[TM.fBlack, TM.fBold, TM.f14]}>
              ...
              පහතින් ලකුණු කර පිළිතුර තොර ඊළග බොත්තම ඔබන්න
            </Text>
          </View>
...
export default FindObjLevel1Screen;
