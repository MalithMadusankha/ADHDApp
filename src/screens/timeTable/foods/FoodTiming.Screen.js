...
import {DAY_TYPE, ESTIMATED_FOOD} from '../../../utility/ConstVaribales';

const FoodTimingScreen = ({navigation, route}) => {
  ...
  const next = () => {
    ...
    clear();
    navigation.navigate('FoodForm', {activity});
  };
...
export default FoodTimingScreen;
